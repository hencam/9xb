...
@section('content')
    ...
    <a href="{{action('RoleController@index')}}" class="btn btn-primary float-right mr-3" title="Manage roles">
        Manage Roles
    </a>
    @isset($employees)
        @if (count($employees) > 0)
            ...
            <table class="w-100">
                ...
                <tr class="border rounded">
                    ...
                    <td class="p-1 text-center">
                        <a href="#" onClick="if (confirm('Are you sure you want to delete this employee?')) document.getElementById('deleteEmployee_{{$employee->id}}').submit(); else return(false);">
